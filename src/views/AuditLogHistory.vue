...
<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-900 to-gray-950 text-white p-5 sm:p-8">
    ...
    <!-- Loading skeletons (mobile cards) -->
    ...
    <section v-if="!loading && paginatedLogs.length" class="mt-4 grid gap-3 sm:hidden">
      ...
      >
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0">
            <div class="text-xs text-slate-400">#{{ (currentPage - 1) * itemsPerPage + index + 1 }}</div>
...
const ACTION_COLORS = {
  create:  { bg: '#10b9811a', fg: '#10b981', br: '#10b98133' }, // emerald
  update:  { bg: '#3b82f61a', fg: '#3b82f6', br: '#3b82f633' }, // blue
  delete:  { bg: '#ef44441a', fg: '#ef4444', br: '#ef444433' }, // red
  login:   { bg: '#f59e0b1a', fg: '#f59e0b', br: '#f59e0b33' }, // amber
  logout:  { bg: '#8b5cf61a', fg: '#8b5cf6', br: '#8b5cf633' }, // violet
  export:  { bg: '#14b8a61a', fg: '#14b8a6', br: '#14b8a633' }, // teal
  default: { bg: '#64748b1a', fg: '#94a3b8', br: '#94a3b833' }  // slate
}

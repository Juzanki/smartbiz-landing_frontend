  ...
  <div class="relative w-screen h-screen overflow-hidden font-sans text-white" :style="backgroundStyle" @click="tapLikeAnywhere">
    ...
    <transition name="fade">
      <div
        ...
        class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-black/80 px-3 py-4 rounded-xl text-base font-bold text-white shadow-xl"
      >
        {{ streamAnnouncement }}
      </div>
    </transition>
    ...
    <!-- 📦 PANELS & MODALS -->
    <transition name="fade">
      <div v-if="showMoreOptions" class="absolute bottom-28 left-1/2 -translate-x-1/2 z-50 px-3 py-4 rounded-xl text-sm text-white bg-black/50 backdrop-blur-md shadow-lg">

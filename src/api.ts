...
// Chukua VITE_API_BASE kwanza; kama haipo, jaribu VITE_API_BASE_URL
const rawBase =
...
export const api: AxiosInstance = axios.create({
  // NB: Ikiwa tunatumia Netlify proxy, baseURL ni "" (origin ya site)
  // na routes zetu bado zinaanza na "/api/...".
